...
| 2026-09-21 | MiniMax H3 VSA 4-step OWL prompt | B580 / `bmg`, PTL-H / `ptl-h` | [Status record with representative frames](2026-09-21-minimax-h3-vsa-4step-owl-status.md) |
